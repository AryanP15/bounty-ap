...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-zinc-100 selection:bg-emerald-500/20 selection:text-emerald-400 font-sans flex flex-col justify-between">
      <div>
      ...
      <footer className="max-w-7xl mx-auto px-6 py-8 mt-12 border-t border-zinc-900 w-full flex flex-col sm:flex-row items-center justify-between text-xs text-zinc-500 font-mono gap-4">
        <div>
          <span>BOUNTYAGENT &copy; 2026 &bull; Autonomous Solana Blinks</span>
        </div>
        <div className="flex items-center gap-3">
          <span>Designed &amp; Developed by <strong className="text-zinc-300">Aryan Pudasaini</strong></span>
          <span className="text-zinc-700">|</span>
          <a 
            href="https://www.linkedin.com/in/aryan-pudasaini-368b09368/" 
            target="_blank" 
          ...
          <span className="text-zinc-700">|</span>
          <a 
            href="https://github.com/AryanP15" 
            target="_blank" 
            rel="noopener noreferrer" 
            className="text-emerald-400 hover:underline"
          >
